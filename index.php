...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-md no-gutters">
                ...
                <div class="collapse navbar-collapse justify-content-center col-md-8 navbar-collapse-1">
                    <ul class="navbar-nav justify-content-center">
                        <li class="nav-item active">
                            <a class="nav-link" href="http://khang/index.php">Home <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="http://khang/html/teams.html">Team</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="http://khang/html/contact.html">Đóng góp ý kiến</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="collapse navbar-collapse justify-content-end col-md-2 navbar-collapse-1">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="http://khang/login/login.html">Log In <i class="fas fa-sign-in-alt"></i></a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6 col-lg-5 ml-md-auto text-left">
                    ...
                    <p><a class="btn btn-secondary mt-4" href="http://khang/search">Tra ngay</a></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Chức năng trang web  -->
    <section id='feature' class="fdb-block bg-dark" style="background-image: url(imgs/hero/purple.svg);">
        <div class="container">
            <div class="row">
            ...
            <div class="row text-center justify-content-sm-center no-gutters">
                <div class="col-12 col-sm-10 col-md-8 col-lg-7 col-xl-3 m-auto">
                    <div class="fdb-box fdb-touch">
                        ...
                        <p class="mt-4"><a href="https:/.froala.com">Learn More <i class="fas fa-angle-right"></i></a></p>
                    </div>
                </div>
            ...
            <div class="row text-center align-items-center">
                <div class="col">
                    <ul class="nav justify-content-center">
                        <li class="nav-item">
                            <a class="nav-link active" href="https:/.froala.com">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="https:/.froala.com">Features</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="https:/.froala.com">Privacy Policy</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="https:/.froala.com">Terms</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="https:/.froala.com">About</a>
                        </li>
                    </ul>
