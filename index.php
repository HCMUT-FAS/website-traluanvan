        ...
        <div class="container">
            <nav class="navbar navbar-expand-md no-gutters">
                <div class="col-2 text-left">
                    <a href="http://traluanvan/index.php">
                ...
                <div class="collapse navbar-collapse justify-content-center col-md-8 navbar-collapse-1">
                    <ul class="navbar-nav justify-content-center">
                        <li class="nav-item active">
                            <a class="nav-link" href="http://traluanvan/index.php">Home <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6 col-lg-5 ml-md-auto text-left">
                    ...
                    <p><a class="btn btn-secondary mt-4" href="http://traluanvan/search">Tra ngay</a></p>
                </div>
            </div>
        </div>
    </section>
