...
if (isset($_SESSION['id'])) {
    // 1. Bảng có tất cả giá trị yêu cầu mượn
    require_once "$rootDir/include/index/header.php";
    require_once "$rootDir/Database/conn.php";
    require_once "$rootDir/include/displayData-admin.php";

    $result_form = $conn->query("SELECT * FROM $formTable WHERE f_NgayTra is null");
    echo "<div><h2>Bảng Đơn Yêu Cầu Mượn</h2>";
    ...
    /*
        ...
        */
    echo "<div><h2>Bảng Lịch Sử Mượn</h2>";
