...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h2><dt>THÔNG TIN VỀ TRANG WEB</dt></h2> 
            <div class="card">
                <div class="card-body">
                    <dl>
                        <h4><dt>Hệ Thống Quản Lý Luận Văn</dt></h4>
                        <dd><strong>Hệ Thống Quản Lý Luận Văn</strong> được tạo ra để giúp cho sinh viên của Đại Học Bách Khoa có thể
                        ...
                        <ul>
                            <li><i aria-hidden="true" class="fa fa-envelope"></i><a href="mailto:khang.bui13032001@hcmut.edu.vn"> Email</a></li> 
                            <li><i class="fab fa-github" aria-hidden="true"></i><a href="https://github.com/Achicken7301"> Github</a></li>
                        </ul>
                        <dd>Với sự giúp đỡ của thầy <strong>Lê Quốc Khải</strong> trong việc lên ý tưởng và giám sát.</dd>
                        <ul>
